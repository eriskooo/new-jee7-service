 ...
 *
 * <p> Example for a builder with deep subclassing hierarchy: </p>
 *
 * <pre>
 *
 ...
 * @param <B> the type of the builder itself, may be useful for deep subclassing
 */
public abstract class AbstractBuilder<E, B extends AbstractBuilder<E, B>> implements Builder<E> {
  ...
  /**
   * Subclasses have to implement this using the following implementation:
   * <pre>
   * protected MyBuilderSubclass thisBuilder() {
   *   return this;
   * }
